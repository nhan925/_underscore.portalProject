...
class YearFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = TabYearBinding.inflate(inflater, container, false)
    ...
    private fun setupTextWatcher(){
        binding.etEnglishYear.addTextChangedListener(object : TextWatcher {
        ...
        binding.etVietnameseYear.addTextChangedListener(object : TextWatcher {
            override fun beforeTextChanged(s: CharSequence?, start: Int, count: Int, after: Int) {
                // to do
            }
    ...
    fun getTranscriptInfo(): Pair<String, Pair<Int, Int>>? {
        return if (selectedYear.isNotEmpty()) {
            Pair(selectedYear, Pair(vnCount, enCount))
        } else {
            null
        }
